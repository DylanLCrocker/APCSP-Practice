...
print("Within The Range: " + str(isinrange))

# 2. Put your existing extraction, bit_text, reconstruction, and report inside the valid branch. Keep the selected label in the report.
